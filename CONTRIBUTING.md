# Contributing to @phillipskevin/scoped-package

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/phillipskevin/@phillipskevin/scoped-package) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork @phillipskevin/scoped-package, you can start by going to its [fork page](https://github.com/phillipskevin/@phillipskevin/scoped-package/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/@phillipskevin/scoped-package
```
...
```shell
cd @phillipskevin/scoped-package
```
